...
import fr.R_3k.saphir.event.loot.SaphirNuggetFromAzurFlower;
...
public class ModEventBusEvents {
    ...
    public static void registerModifierSerializers(@Nonnull final
        ...
        event.getRegistry().registerAll(
                new SaphirNuggetFromAzurFlower.Serializer().setRegistryName
                        (new ResourceLocation(Saphir.MODID,"saphir_nuggets_from_azur_flower"))
        );
    }
}