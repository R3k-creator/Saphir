...
public class dowsing_rod_2 extends Item {
    public dowsing_rod_2(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(new TranslatableComponent("tooltip.saphir.dowsing_rod_2.tooltip.shift"));
        } else {
            pTooltipComponents.add(new TranslatableComponent("tooltip.saphir.dowsing_rod_2.tooltip"));
            pTooltipComponents.add(new TranslatableComponent("tooltip.saphir.dowsing_rod_2.tooltip.level"));
        }
    }
    ...
    private boolean isValuableBlock(Block block) {
        return Registry.BLOCK.getHolderOrThrow(Registry.BLOCK.getResourceKey(block).get()).is(ModTags.Blocks.DOWSING_ROD_VALUABLES_2);
    }
